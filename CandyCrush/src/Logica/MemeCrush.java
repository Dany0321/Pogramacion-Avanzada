...
public class MemeCrush {
    ...
    /**
     * Metodo que busca en la matriz cuantos numeros hay seguidos en X y retorna ese numero, para luego borrar eso en la matriz con otro metodo
    ...
    /**
     * Metodo que busca en la matriz cuantos numeros hay seguidos en Y y retorna ese numero, para luego borrar eso en la matriz con otro metodo
     * @param matrizComprobante matriz a verificar
     * @return int que expresa ese numero de veces para borrar
     */
     ...
     * @param posxUsuario coordenada en i a la que el usuario realizo el movimiento
     * @param posyUsuario coordinada en j a la que el usuario realizo el movimiento
     */    
    ...
    //HAY QUE HACER UN METODO PARA SUBIR LOS CEROS, recorrer la matris en busca de 0 (exectuando la primera fila)
    //si encuentra un cero lo cambia con el que tenga arriba y aumenta el valor de un contador cuando termina el metodo
    //si el contador es mayor a 0 entonces lo vuevle a ejecutar (esto asegura que todos los 0 esten en la parte de mas ariba que puedan estar
